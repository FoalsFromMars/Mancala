...
public class otherMancala 
{
    ...
    public static void main(String[] args) throws Exception 
    {
    	...
    	switch (args.length) 
    	{
    		...
    		case 0:
    		default: 
    			player1 = new String("crewshillPlayer");
    			player2 = new String("randoPlayer");
    			break;
    	}
    	...
    	case 1: 
    		...
    		{
    			otherMancala.gui.textArea.append(player1+":1 has won the match by default\n");
    		}
    		else 
    		{
    			otherMancala.gui.textArea.append(player1+":1 has won the match " +
    	...
    	case 2: 
    		if (match.getPlayer2Score() == -1) {
    			otherMancala.gui.textArea.append(player2+":2 has won the match by default\n" );
    		}
    		else 
    		{
    			otherMancala.gui.textArea.append(player2+":2 has won the match " +
    					   match.getPlayer2Score() + " to " +
    					   match.getPlayer1Score() + "\n");
    		}
	    break;
    	case 0:
    		otherMancala.gui.textArea.append(player1+":1 and "+player2+":2 tie at " +
