...
public class Match {
	...
	while (!gameContext.gameOver()) {
	    ...
	    {
	    	otherMancala.gui.textArea.append("** Player moves again! **\n");
	    ...
	    if (player1Move) 
	    {
	    	...
	    	otherMancala.gui.textArea.append("PLAYER 1 TO MOVE:\n");
	    	//System.out.println("PLAYER 1 TO MOVE:");
	    }
	    else 
	    {
	    	currentMover = player2;
	    	otherMancala.gui.textArea.append("PLAYER 2 TO MOVE:\n");
		...
		synchronized (mutex) {
			...
			otherMancala.gui.textArea.append("Thread timeout expired\n");
		...
		if (currentMover == player1) {
			otherMancala.gui.textArea.append("Player 1 made an illegal move.\n");
		    //System.out.println("Player 1 made an illegal move.");
		    return 2;
		}
		else {
			otherMancala.gui.textArea.append("Player 2 made an illegal move.\n");
		    //System.out.println("Player 2 made an illegal move.");
		    return 1;
		}
	    }
	    otherMancala.gui.applyMove(move, player1Move, new GameState(gameContext)); //update the GUI
